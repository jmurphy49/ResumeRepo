...
namespace ResumePage.Controllers
{
    public class ReferencesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Adress,City,Email,FName,LName,Phone,State,Relation")] Reference reference)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Adress,City,Email,FName,LName,Phone,State,Relation")] Reference reference)
        {
            if (id != reference.ID)
            {
                return NotFound();
